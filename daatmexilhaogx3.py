...
pathname = os.environ['HOME'] + '/Dropbox/ambidados/dados/Mexilhao_gx3_triaxys/gx3/'
...
aew = pd.read_csv(pathname + 'TOA5_55915.microstrain_stbaclEW.dat', 
	skiprows=4, header=None, index_col=0, parse_dates=True)

ans = pd.read_csv(pathname + 'TOA5_55915.microstrain_stbaclNS.dat', 
	skiprows=4, header=None, index_col=0, parse_dates=True)

av = pd.read_csv(pathname + 'TOA5_55915.microstrain_stbaclV.dat', 
	skiprows=4, header=None, index_col=0, parse_dates=True)
