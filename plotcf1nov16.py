...
pathfig  = os.environ['HOME'] + '/Dropbox/atmosmarine/web/cf1nov16/img/'

#carrega os dados da boia
dd = pd.read_csv(pathname + 'cf1nov16.csv', index_col='date', parse_dates=True)

#pega dados quando a boia foi para agua
dd = dd['2016-11-05 20:00':]
# dd = dd['2016-12-29 00:00':'2017-01-01 10:00']

#carrega dados da previsao 
nww3 = pd.read_csv(os.environ['HOME'] + '/Dropbox/database/forecast/nww3/NWW3_REMO_CF01.csv',
...
ax2.plot(dd.lon,dd.lat,'b-', alpha=0.3)
ax2.plot(dd.lon[-24:],dd.lat[-24:],'r-', alpha=0.6)
...
ax2.plot(dd.lon,dd.lat,'.', color='g', alpha=0.5)
ax2.plot(dd.lon[-1],dd.lat[-1],'ro')
ax2.set_xlabel('Longitude (Dec. Graus)')
ax2.set_ylabel('Latitude (Dec. Graus)')
