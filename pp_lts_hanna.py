''' Processamento dos dados de onda do sensor 
	...
	Processamento em batelada dos dados da boia
	do LTS
'''
...
#pathname
pathname_gx3 = '/home/lioc/Dropbox/ambid/dados/Ilha_Rasa-LTS-gx3_20141209_20150202/'

#carrega dados de aV do gx3
dados_av_gx3 = np.loadtxt(pathname_gx3 + 'TOA5_61689.microstrain_stbaclV.dat',
	dtype=str,delimiter=',',skiprows=4)
dados_aew_gx3 = np.loadtxt(pathname_gx3 + 'TOA5_61689.microstrain_stbaclEW.dat',
	dtype=str,delimiter=',',skiprows=4)
dados_ans_gx3 = np.loadtxt(pathname_gx3 + 'TOA5_61689.microstrain_stbaclNS.dat',
	dtype=str,delimiter=',',skiprows=4)
...
for kk in range(av_gx3_mat.shape[1]):
# for kk in range(108,109): #processa o arquivo 201406070700
	...
	#tempo
	hs,h10,hmax,tmed,thmax = proconda.ondat(t_gx3,av_gx3,h)
	...
	av_gx3,aew_gx3,ans_gx3,h,nfft_gx3,fs_gx3)
	...
	#espectro de heave do gx3 pela divisao por w4
	sn_eta1_gx3 = sn[:,1] / ((2*np.pi*f_gx3) ** 4)

	#### calcular hs do espectro de heave obtido pela divisao por w4
