...
x=dt*100;
f1=1/x:1/x:50/x;%vetor de frequ�ncias
...
for ik=1:ik;
    ...
    if media>0.1,
        ...
        g=find(g5>0);g5(g)=100./g5(g);

        %preparo final do energ
        %ww55(7:10)=g5;
        tp_daat(ik)=g5(1,1); %período para verificacao
        %whosenerg(:,kkl)=ww55;
        
        % calculo das direcoes
        r1=cpsd(co,dc,100,50);
        r2=cpsd(co,dd,100,50);
        a8=imag(r1(2:51));
        a9=imag(r2(2:51));
        c0=angle(a8+j*a9);
        c0=c0*180/pi;
