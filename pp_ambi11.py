''' Processamento dos dados de onda do sensor 
	...
	Espectros de fase com utilizando as series
	de heave do gx3, obtido pela integracao
	numerica.
	Os dados serao comparados com a saida da axys
'''
...
data_gx3_str = aew_gx3[j,0] #data em string

#heave do gx3
eta_gx3 = eta_gx3_mat[:,j]
...
t_gx3 = np.arange(0,len(eta_gx3)*dt_gx3,dt_gx3)
...
aa_eta_gx3 = espec.espec1(eta_gx3,nfft_gx3,fs_gx3)
...
aa_etaaew_gx3 = espec.espec2(eta_gx3,ans_gx3,nfft_gx3,fs_gx3)
aa_etaans_gx3 = espec.espec2(eta_gx3,aew_gx3,nfft_gx3,fs_gx3)
...
pl.subplot(211)
pl.title('Auto-Espectros de Heave e Aceleracao - GX3')
pl.plot(f_gx3,aa_eta_gx3[:,1],'b',label='eta-gx3')
...
pl.subplot(212)
pl.title('Espectro de Fase - Heave e acEW')
pl.plot(f_gx3,aa_etaaew_gx3[:,4],'b',label='Fase-gx3')
pl.ylabel('graus'), pl.xlabel('freq. (Hz)'), pl.grid('on')

# pl.savefig('saida/fase_etaacEW-gx3.png')
...
pl.subplot(212)
pl.title('Espectro de Fase - Heave e acNS')
pl.plot(f_gx3,aa_etaans_gx3[:,4],'b',label='Fase-gx3')
pl.ylabel('graus'), pl.xlabel('freq. (Hz)'), pl.grid('on')

# pl.savefig('saida/fase_etaacNS-gx3.png')
...
# pl.savefig('saida/fase_acEWacNS-gx3_1.png')
...
# pl.savefig('saida/fase_etaetax-axys_1.png')
...
# pl.savefig('saida/fase_etaetay-axys_1.png')
...
# pl.savefig('saida/fase_etaxetay-axys_1.png')

#fig 7 - series temporais de heave e aceleracao
pl.figure()

pl.subplot(211)
pl.title('Series Temporais - GX3')
pl.plot(t_gx3[0:78],-eta_gx3[0:78],label='- eta-gx3') #[0:78] para ir o mesmo tempo da axys, pois sao diferentes dt
...
# pl.savefig('saida/series-gx3_axys_1.png')

#fig 8 - series temporais de heave do gx3 (int) e heave da axys
pl.figure()

pl.title('Series de heave da AXYS e GX3')
pl.plot(t_gx3[0:78],-eta_gx3[0:78],'b',label='-eta_gx3') #o av tem que estar como o eta (ver no inicio da rotina)
pl.ylabel('metros'), pl.legend(loc=2), pl.grid('on')
pl.twinx()
pl.plot(t_axys[0:100],eta_axys[0:100],'r',label='eta_axys')
pl.ylabel('metros'), pl.legend()
pl.xlabel('Tempo (s)')

# pl.savefig('saida/series_heave-gx3_axys.png')
