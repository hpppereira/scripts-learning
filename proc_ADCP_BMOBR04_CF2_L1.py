...
da boia Susana (BMOBR04 (ou 02??) CF2)
...
pathname = os.environ['HOME'] + '/Dropbox/Sistemas-BMOP/Dados/BMOBR03/cartao/ADCP/txt/DPL3_034.txt'
dd = dd['2015-03-04 17':] #periodo de dados bons


dateparse = lambda x: pd.datetime.strptime(x, '%y %m %d %H %M %S')

dd = pd.read_table(pathname ,skiprows=15, parse_dates=[['YR','MO','DA','HH','MM','SS']],
	date_parser=dateparse, index_col='YR_MO_DA_HH_MM_SS',
	names=['Ens','YR','MO','DA','HH','MM','SS','NAN','NAN','Pit','Rol','Hea','Tem','Dep','Ori','BIT','Bat',
...
mag  = dd[['Mag1','Mag2','Mag3','Mag4','Mag5','Mag6','Mag7','Mag8','Mag9','Mag10']].values.T / 1000
dire = dd[['Dir1','Dir2','Dir3','Dir4','Dir5','Dir6','Dir7','Dir8','Dir9','Dir10']].values.T / 1000
u    = dd[['Eas1','Eas2','Eas3','Eas4','Eas5','Eas6','Eas7','Eas8','Eas9','Eas10']].values.T / 1000
v    = dd[['Nor1','Nor2','Nor3','Nor4','Nor5','Nor6','Nor7','Nor8','Nor9','Nor10']].values.T / 1000
...
ax3.grid()
#pl.savefig('fig/BMOBR03_CF1_Lanc1_ADCP_Status.png', bbox_inches='tight')

fig = pl.figure(figsize=(12,7),facecolor='w')
ax = fig.add_subplot(111)
con = ax.contourf(np.flipud(mag),np.arange(0,1,0.001),color='k')
pl.colorbar(con,label=r'ms$^{-1}$')
qwind = ax.quiver(u, v, units='xy', scale=0.005, headwidth=0, pivot='tail', width=0.25, linewidths=(0.001,), edgecolors='k', color='k', alpha=1)
...
#pl.savefig('fig/BMOBR03_CF1_Lanc1_ADCP_MagDir.png', bbox_inches='tight')
