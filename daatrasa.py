...
Adaptado para o sensor Microstrain
Hanna L. V. Medeiros

Ultima modificacao: 15/07/2016
'''
...
pathname = os.environ['HOME'] + '/Documentos/DAAT_PLEDS/DAAT_PLEDS_python/ilha_rasa/dados/' # '/Dropbox/siodoc/dados/brutos/'
...
V1 = np.loadtxt(pathname + 'microstrain_stbaclV1.dat')
...
for ik in list(arange(hv.shape[0])):
    ...
    ww55[1] = sum(qq1[1:19])
    ww55[2] = sum(qq1[18:36])
    ww55[3] = sum(qq1[35:70])
    ww55[4] = sum(qq1[69:])
...
# Pega vento
pathname1 = os.environ['HOME'] + '/Documentos/siodoc/dados/proc/' # '/Dropbox/siodoc/dados/brutos/'
# periodo = '2014-10'
# dmag = -23
