function[Spico,fSpico,dSpico,Scava,fScava,dScava] = sele_picoP40(VS,VD,VF,VSPK,ngl,pdir,deltaf,arqdwv)
%
...
% Essa função foi substituída pela sele_picoMiros em 10/mai/2011, pois também funciona com
% os demais MIROS de outras plataformas.
haviso = warndlg(' Essa função foi substituída pela sele_picoMiros em 10/mai/2011','Aviso!');
waitfor(haviso);
