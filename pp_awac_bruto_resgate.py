'''
Processamento dos dados do mes de fev/2013
dos dados brutos do adcp da vale
'''
...
pathname = os.environ['HOME'] + '/Dropbox/lioc/dados/ww3vale/ADCP/bruto/ADCP_Vale_1_2/Resgate_' + resgate + '/ST00' + adcp + '/Dados_Brutos/'
...
ddv = np.loadtxt(pathname + 'adcp' + adcp + '_vale.out',delimiter=',')
