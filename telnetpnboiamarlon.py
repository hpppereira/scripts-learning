...
#                print resultado
                ...
                if len(resultado) == 47:
                    ...
                    if resultado[15] == "02":
                        #                           0 - date-time               1=bat      2=hs       3=tp         4=dp
                ...
                if len(resultado) == 40 or len(resultado) == 41 or len(resultado) == 42 or len(resultado) == 43:
                    if resultado[15] == "01":
                        bat.append([str(resultado[12]) + " " + str(resultado[13]), str(resultado[26]), resultado[30],resultado[31],resultado[32]])
                    if resultado[15] == "02":
                        final = [str(resultado[12]) + " " + str(resultado[13]),"bat",resultado[35],resultado[37],resultado[38],resultado[36],resultado[17],resultado[18],resultado[19],"ws2","wg2","wd2",resultado[20],resultado[21],resultado[22],resultado[23],resultado[24]]
               ...
               # print final           
                ...
                if final != []: 
                    with open(str(nome_arq) + '.csv', 'a') as csvfile:
                     ...
                     writer.writerow({'date': final[0],'bat': final[1],'hs': final[5],'tp': final[6],'dp': final[7],'hmax': final[8],'ws1': final[6],'wg1': final[7],'wd1': final[8],'ws2': final[9],'wg2': final[10],'wd2': final[11],'at': final[12],'rh': final[13],'dwp': final[14],'pr': final[15],'sst': final[16] })
    return
