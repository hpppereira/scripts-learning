...
#salva arquivos
pl.savetxt(os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/rot/saida/bruto/paramw1.out',paramw1,\
	delimiter=',',fmt=['%i']+5*['%.2f'],header='data,hs,hmax,hm0,tp,dp')
pl.savetxt(os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/rot/saida/bruto/paramw2.out',paramw2,\
	delimiter=',',fmt=['%i']+5*['%.2f'],header='data,hs,hmax,hm0,tp,dp')
pl.savetxt(os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/rot/saida/bruto/paramw3.out',paramw3,\
	delimiter=',',fmt=['%i']+5*['%.2f'],header='data,hs,hmax,hm0,tp,dp')
pl.savetxt(os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/rot/saida/bruto/paramw4.out',paramw4,\
	delimiter=',',fmt=['%i']+5*['%.2f'],header='data,hs,hmax,hm0,tp,dp')