...
%Ultima atualizaçao:26/08
%--------------------------------------------------

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%observaçoes da ultima atualizaçao
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%save d:\users\joao\orientandos\eduardo\dadosteste1.txt -ascii dadosteste 
%save d:\users\joao\orientandos\eduardo\dirfp1.txt -ascii dirfp
