...
%gx3 e axys
tebig = load('/home/lioc/Dropbox/ambid/dados/TEBIG-axys_gx3_20140522/bmo.mat');

%aceleracao Z
tebig1 = load('/home/lioc/Dropbox/ambid/dados/TEBIG-axys_gx3_20140522/bmo1.mat');

%define variaveis da axys e gx3 da Ambidados (coluna 4 da gx3 que eh a 1 da axys)

%GX3 - TEBIG
n1 = tebig1.stabacelZ(1,2:end) .* -9.81; %corrige acZ e 'g' para m/s^2
n2 = tebig.gx3_ac_EW(4,:); %pitch
n3 = tebig.gx3_ac_NS(4,:); %roll

%AXYS - TEBIG
% n1 = tebig.axys_heave(1,:);
% n2 = tebig.axys_disp_E(1,:);
% n3 = tebig.axys_disp_N(1,:);

%AXYS - RIO_GRANDE PNBOIA
% rio_grande_ax = '/home/lioc/Documents/pnboia/dados/axys/rio_grande/hne/200905090600.HNE';
% [n1, n2, n3] = loadhne(rio_grande_ax);
...
% pathname = '/home/lioc/Documents/pnboia/dados/axys/rio_grande/hne/';
% arq=load('list_RSmay09.txt');
...
energ = zeros(10,ik); %Hm0 + 4 energias (uma por faixa), valor zero, 4 picos (maiores)
