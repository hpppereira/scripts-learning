...
def pleds(espe1,dire1,ws1,wd1):
	...
	pl.text(1.13,286,'DIRECTIONAL WAVE SPECTRUM - Rio Grande/RS - 2009/05 - PNBOIA (AXYS 3M)')
	...
	pl.savefig('pledspy.png',format='png', dpi=1200)
