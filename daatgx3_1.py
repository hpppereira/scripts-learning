...
#     delimiter=' ',skiprows=4,dtype=str)
aew = np.loadtxt(pathname + 'TOA5_61689.microstrain_stbaclEW.dat',
    delimiter=',',skiprows=4,dtype=str)
ans = np.loadtxt(pathname + 'TOA5_61689.microstrain_stbaclNS.dat',
    delimiter=',',skiprows=4,dtype=str)
#o acv esta delimitado com espaco
av  = np.loadtxt(pathname + 'TOA5_61689.microstrain_stbaclV.dat',
    delimiter=',',skiprows=4,dtype=str)
