function [heave,ano,mes,dia,hora,min,sdata,stime]=le_SIMO(arqdwv,DT);
%
% Funcao para leitura das series temporais de heave formato SIMO 
%     no caso de dados não direcionais
%
%  J.A. LIma/João Marcos 10/04/2002
%
...
heave=[];
for k=1:2400 % Loop para leitura das series de heave
