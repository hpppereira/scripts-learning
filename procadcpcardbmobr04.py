...
pathname_root = os.environ['HOME'] + '/Dropbox/projetos/BMOP/Sistemas-BMOP/Processamento/dados/'

#---------------------------------------------------------------------------#
#choose the data
pathname = pathname_root + 'BMOBR04_CF2/Lanc1/ADCP/cartao/txt/'
#pathname = pathname_root + 'BMOBR03_CF1/Lanc1/ADCP/txt/'
#pathname = pathname_root + 'BMOBR03_CF1/Lanc2/ADCP/cartao/txt/DPL3_034.txt'

#path and figure name to save
figname = 'fig/BMOBR04_CF2_Lanc1_ADCP'

#---------------------------------------------------------------------------#

#list files inside pathname
...
#magnitude matrix (m/s) - for contour plot
...
ax3.grid()
pl.savefig(figname + '_Status.png', bbox_inches='tight')
...
pl.savefig(figname + '_Vel.png', bbox_inches='tight')
