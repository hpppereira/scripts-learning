...
pathname_ww3  = os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/Previsao/Previsao_14maio/'
pathname_swan = os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/Previsao/Previsao_14maio/'
pathname_mb = os.environ['HOME'] + '/Dropbox/pnboia/dados/mb/' #planilha excel baixada do site da MB
