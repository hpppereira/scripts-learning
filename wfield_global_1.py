# The program reads the output wave field files from wavewatch III v 3.14. Global grid 1
...
for k in range(0, narq):
	...
	if cfig>0:
		...
		map.contourf(xx,yy,m[k,:,:],levels,cmap=palette,norm=colors.normalize(vmin=0,vmax=16,clip=False))
