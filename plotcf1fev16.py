...
pathname = os.environ['HOME'] + '/Dropbox/database/historical/buoys/remo/CF1_BMOBR05_2016Fev/op/'
pathfig  = os.environ['HOME'] + '/Dropbox/atmosmarine/websites/cf1fev16/img/'

#carrega os dados da boia
dd = pd.read_csv(pathname + 'cf1fev16.csv', index_col='date', parse_dates=True)
