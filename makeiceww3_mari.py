...
name='icecon.gdas.199901.nc';tn=1
rname='CFSR'
...
#Para ver a variavel no python copiar desde a linha 63 ate a 87,import matplotlib, e dpois fu = nc('icecon.gdas.199701.nc', 'r')
#dar fu.variables
...
fl = open('log_iceWW3_199901.txt', 'w')
...
icec=fu.variables['ICEC_surface'][:]
...
for tn in range(0,tn):
	...
	#for t in range(0,2):
		...
		icec=fu.variables['ICEC_surface'][t,alati:alatf+1,:]
