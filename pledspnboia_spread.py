...
espe = np.loadtxt('tmp/espe.txt')
dire = np.loadtxt('tmp/dire.txt')
energ = np.loadtxt('tmp/energ.txt')
spread = np.loadtxt('tmp/spread.txt')
...
pl.savefig('pleds_teste.png' ,format='png', bbox_inches='tight')
