...
pathname = os.environ['HOME'] + '/Dropbox/ww3vale/TU/rot/out/bruto/parametros/'
...
wadcp01_fev = np.loadtxt(os.environ['HOME'] + '/Dropbox/ww3vale/TU/hindcast/resultados/201302/tab51.ww3',skiprows=3,usecols=(0,1,4,9,10))
wadcp01_jul = np.loadtxt(os.environ['HOME'] + '/Dropbox/ww3vale/TU/hindcast/resultados/201307/tab51.ww3',skiprows=3,usecols=(0,1,4,9,10))
