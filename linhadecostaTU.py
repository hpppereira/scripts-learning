...
pathname = os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/dados/linhadecosta/polig/'

pols = os.listdir(pathname)
...
coll = PolyCollection(verts, array=z, cmap=mpl.cm.Oranges_r, edgecolors='none')
