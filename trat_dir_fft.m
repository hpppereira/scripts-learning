function[VD,VPED,VNUM,VESP,VEPK,a1,b1,a2,b2,Rcheck] = trat_dir_fft(VF,noverlap,w,heave,etaEW,etaNS,DT,DONV,kVTPK,nfft,dboia,prof)
%
% Antiga trat_dir_atual . Mudança de nome apenas, para diferenciar da
% trat_dir_EMEM de tratamento direcional 2D. Ricardo Campos - 09/12/2010
% 
...
%==========================================================================
%cp: Trecho para escolher o angulo theta obtido a partir de
...
% dirp1=dirp1*(180/pi)+DONV;
% g1=find(dirp1<0);dirp1(g1)=dirp1(g1)+360;
% g1=find(dirp1>360);dirp1(g1)=dirp1(g1)-360;
...
%rr1=sqrt(d1+d2);
%spr=sqrt(2-2*rr1);
%spr=spr*57.3; % conversÃ£o de radianos para graus
