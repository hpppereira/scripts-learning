...
sed1 = pd.read_csv(pathname_sed + 'marseal_gran.csv') #em phi
sed2 = pd.read_csv(pathname_sed + 'literatura_gran.csv') #em mm

#retira os dados que nao tem valor
sed2 = sed2.loc[sed2.TEXTURA.isnull() == False]

#cria variavel com tamanho do grao
sed1['grao'] = sed1.MEDIANA #esta em phi
sed2['grao'] = sed2.TEXTURA #esta em mm

#passa grao para cm
sed1['grao'] = 1 * (2 ** - sed1.grao) * 0.1 #de phi para cm
sed2['grao'] = sed2.grao * 0.1 #de mm para cm
