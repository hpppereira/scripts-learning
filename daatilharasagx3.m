...
[a, b] = size(gx3.av);
dire = zeros(10,a); %direcao (2 valores, ate  5 faixas)
espe = zeros(10,a); %espectros (2 valores, ate 5 faixas)
energ = zeros(10,a); %Hm0 + 4 energias (uma por faixa), valor zero, 4 picos (maiores)
% dire1 = dire;
% espe1 = espe;
...
for ik = 1:ikk
    ...
    if isnan(co)        
        ...
        faixa1 = [6:10]'; % 32 - 10.6 s
        faixa2 = [11:15]'; % 9.1 - 7.1 s
        faixa3 = [16:24]'; % 6.4 - 4.2 s
        faixa4 = [25:length(qq1)]'; % 4 - 1.6 s
