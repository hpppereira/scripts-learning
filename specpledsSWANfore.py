...
#previsao do dia 5 de maio
pathname = os.environ['HOME'] + '/Dropbox/ww3vale/TU/Previsao/Previsao_14maio/20150513/'
filename = 'spec_point_ADCP10.out'

#pathname = os.environ['HOME'] + '/Dropbox/ww3vale/TU/hindcast/2013/201302/'
