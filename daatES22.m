...
if length(a15)>1,%caso existam valores selecionados
    ...
    for k=1:length(a15),bb=a15(k);w1(bb)=w1(bb)+sp2(k);
        w2(bb)=w2(bb)+1;
    end;
...
%jogo fora valores espa�ados de menos de 50 graaus
if abs(p(1)-p(2))<20,e(2)=0;p(2)=0;
else;
    %    %ou pequenos
    if e(2)<0.1*e(1),e(2)=0;p(2)=0;
    end;
end;

% %normaliza��o com as energias das faixas obtidas do espectro 1D
z1=ww55(iwq+1);
p=[p;0;0;0];p=p(1:2);
e=[e;0;0;0];e=e(1:2);
e=e*z1/sum(e);
