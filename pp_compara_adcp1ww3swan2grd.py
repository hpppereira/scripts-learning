'''
Compara ww3, swan (2 grades) e adcp01
processado pela vale
...
#diretorio de onde estao os dados processados pela vale
...
for dto in direm:
    ...
    #pula a primeira linha pois ja eh a mesma do ultimo arquivo
