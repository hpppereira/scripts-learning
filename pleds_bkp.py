...
def pleds(espe, dire, title='', figname='pleds_teste.png'):
    ...
    dire = dire + pl.rand(8,dire.shape[1]) * 20 - 20/2  #cria randomico
    ...
    pl.text(22,248+30,'DIRECTIONAL WAVE SPECTRUM EVOLUTION (DAAT/PLEDS) - %s' \
                      %(title))
...
if __name__ == '__main__':
    ...
    espe = np.loadtxt('../out/espe_buoy.txt')
    dire = np.loadtxt('../out/dire_buoy.txt')
    title = 'BREMERENDA - Buoy'
    figname = 'pleds_buoy.png'
    pleds(espe, dire, title, figname)
