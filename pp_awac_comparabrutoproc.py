...
ddl1 = np.loadtxt(pathname + 'paramw1.out',delimiter=',')
ddl2 = np.loadtxt(pathname + 'paramw2.out',delimiter=',')
ddl3 = np.loadtxt(pathname + 'paramw3.out',delimiter=',')
ddl4 = np.loadtxt(pathname + 'paramw4.out',delimiter=',')
...
pathname  = os.environ['HOME'] + '/Dropbox/ww3vale/Geral/TU/rot/saida/proc/'

#   0    1    2     3     4      5       6      7   8
# data, hm0, h10, hmax, dirtp, sprtp, meandir, tp, tm02'
ddv1 = np.loadtxt(pathname + 'adcp1_vale.out',delimiter=',')
ddv2 = np.loadtxt(pathname + 'adcp2_vale.out',delimiter=',')
ddv3 = np.loadtxt(pathname + 'adcp3_vale.out',delimiter=',')
ddv4 = np.loadtxt(pathname + 'adcp4_vale.out',delimiter=',')
...
pl.legend(loc=0,fontsize=10)
pl.ylabel('Hs (m)'), pl.grid()
pl.xlim(datam_sadcp03_fev[0],datam_sadcp03_fev[-1]), pl.ylim(0,3)
pl.xticks(rotation=10,visible=False)
pl.subplot(323)
...
pl.ylabel('Tp (s)'), pl.grid()
pl.xlim(datam_sadcp03_fev[0],datam_sadcp03_fev[-1]), pl.ylim(2,18)
pl.xticks(rotation=10,visible=False)
pl.subplot(325)
...
pl.ylabel('Dp (graus)'), pl.grid()
pl.xlim(datam_sadcp03_fev[0],datam_sadcp03_fev[-1]), pl.ylim(0,250)
pl.xticks(rotation=15)
...
pl.grid()
pl.xlim(datam_sadcp03_jul[0],datam_sadcp03_jul[-1]), pl.ylim(0,3)
pl.xticks(rotation=10,visible=False)
pl.subplot(324)
pl.plot(datat3lioc,ddl3[:,4],'b.')
pl.plot(datat3vale,ddv3[:,7],'r.')
...
pl.grid()
pl.xlim(datam_sadcp03_jul[0],datam_sadcp03_jul[-1]), pl.ylim(2,18)
pl.xticks(rotation=10,visible=False)
pl.subplot(326)
pl.plot(datat3lioc,ddl3[:,5],'b.')
pl.plot(datat3vale,ddv3[:,4],'r.')
...
pl.grid()
pl.xlim(datam_sadcp03_jul[0],datam_sadcp03_jul[-1]), pl.ylim(0,250)
pl.xticks(rotation=15)
...
###########################################################
#avaliacao de direcao entre lioc, vale e ww3

# pl.figure()
# pl.plot(datat1lioc,ddl1[:,5],'b.',label='Dp_lioc')
# pl.plot(datat1vale,ddv1[:,4],'r.',label='Dp_vale')
# pl.plot(datam_wadcp01,wadcp01[:,7],'g.',label='Dp_ww3')
# pl.plot(datam_wadcp01_jul,wadcp01_jul[:,7],'g.')
# pl.legend()	
...
# plt.figure()
# pl.plot(datat1lioc,ddl1[:,5],'b.',label='Dp_lioc')
# pl.plot(datat1lioc,ddl1[:,5]+90,'g.',label='Dp_lioc+90')
# pl.plot(datat1lioc,ddl1[:,5]+90-23,'y.',label='Dp_lioc+90+dmag')
# pl.plot(datat1vale,ddv1[:,4],'r.',label='Dp_vale')
# pl.legend()	
...
# pl.plot(data2lioc,paramw2[:,6],'o',label='Hm0')
