...
%ger as faixas de periodos e localizacao automatica
...
aux1i = num2str(1./f1(faixa11(1)));
aux2i = num2str(1./f1(faixa22(1)));
aux3i = num2str(1./f1(faixa33(1)));
aux4i = num2str(1./f1(faixa44(1)));

aux1f = num2str(1./f1(faixa11(end)));
aux2f = num2str(1./f1(faixa22(end)));
aux3f = num2str(1./f1(faixa33(end)));
aux4f = num2str(1./f1(faixa44(end)));

k1 = [];
k1 = [[aux1i(1:4),' a ',aux1f(1:4)] ; ...
      [aux2i(1:4),' a ',aux2f(1:4)] ; ...
      [aux3i(1:4),' a ',aux3f(1:4)] ; ...
      [aux4i(1:4),' a ',aux4f(1:4)] ; ...
      '5 div=10m/s' ;...
      '5 div=0.1m2'];
...
%     end;    
%     text(1,205,['DIRECTIONAL WAVE SPECTRUM (32g) - ', list_month(6:7),' - ', ad(mes,:) '/' num2str(ano)],...
%     'fontsize',18,'color','b')
% else
    ...
    text(1,290,['DIRECTIONAL WAVE SPECTRUM - ',list_month(6:7),' - ',ad(mes,:) '/' num2str(ano)],...
    'fontsize',18,'color','b')
% end
...
text(1.15,40,'days of month','fontsize',12,'rotation',90); % ??dire1(3,:)=dire1(7,:);
w=[[1;6] [2;7] [3;8] [4;9]];
...
figsave = ['saida/pleds',list_month(5:12)];

set(gcf,'paperOrientation','portrait','paperposition',[1 1 15 15],...
     'paperSize',[15 15]);
% eval(['print(figure1,''-dpcx256'','figsave,''')'])

print(figure1,'-dpcx256',figsave)
